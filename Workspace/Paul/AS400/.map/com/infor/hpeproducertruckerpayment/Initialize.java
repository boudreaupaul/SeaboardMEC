...
public class Initialize extends Globals {
	...
	private void initialize() throws Throwable {
    	...
    	// Create hash map addressData
    	//addressData = new java.util.HashMap<String, String>();
    	
    	// Create hash map communicationData
    	//communicationData = new java.util.HashMap<String, String>();
    	
    	// Create hash map classificationData
    	//classificationData = new java.util.HashMap<String, String>();
